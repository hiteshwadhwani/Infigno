...
const CarrerCounselling = () => {
  return (
    <div className="w-[95vw] lg:w-[70vw] m-auto">
      ...
      <div className="bg-gradient-to-br from-[#1E86FF] to-[#0047AB] rounded-2xl px-5 pt-5 md:px-10 md:pt-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-y-6">
          <div>
            ...
            <div className="text-white bg-gradient-to-br from-[#004EC1] rounded-2xl p-4 mt-6 md:w-[70%]">
        ...
        <div className="flex flex-col relative mt-16 min-h-[600px] h-fit">
          <div className="flex flex-col gap-y-4 lg:max-w-[40%]">
