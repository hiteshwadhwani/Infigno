    ...
    <div className="flex flex-col w-full">
      ...
      <div className="bg-[#004EC1] p-[40px]">
        <div className=" bg-white rounded-3xl md:px-[40px] pt-[20px] md:pt-[40px] grid grid-cols-1 xl:grid-cols-3 overflow-hidden">
          <div className="items-center md:items-start p-[20px] flex flex-col gap-y-4">
            ...
            <CertifiedCard>
              Earn up to <br />{" "}
              <span className="text-red-600 font-semibold text-xl">32 Lakh*</span>
          ...
          <div className="relative h-[309.974px] w-[320px] md:h-full md:w-full sm:mt-4 sm:mb-8 z-10">
            {/* <Image src={"/images/people.svg"} alt="image" fill className="mb-auto scale-100 md:scale-110 xl:scale-125"/> */}
            <Image src={"/images/people.svg"} alt="image" fill className="object-cover xl:object-contain scale-100 md:scale-110 xl:scale-125"/>
          </div>
          <CertifiedForm />
        </div>
      </div>
      ...
      <div className="mt-20">
        <div className="text-3xl text-center">
            Why be a <span className="font-semibold">certified career planner?</span>
        </div>
        <div className="bg-[#034DB3] mt-12 bg-bg2 bg-no-repeat bg-right w-[80vw] mx-auto rounded-3xl grid grid-cols-1 lg:grid-cols-2 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
                <Card2 title="Strong Earning Potential" description="Earn up to ₹32.4 Lakh per annum as a Career Counsellor." />
                <Card2 title="Strong Earning Potential" description="Earn up to ₹32.4 Lakh per annum as a Career Counsellor." />
                <Card2 title="Strong Earning Potential" description="Earn up to ₹32.4 Lakh per annum as a Career Counsellor." />
                <Card2 title="Strong Earning Potential" description="Earn up to ₹32.4 Lakh per annum as a Career Counsellor." />
                <Card2 title="Strong Earning Potential" description="Earn up to ₹32.4 Lakh per annum as a Career Counsellor." />
            ...
            <div className="relative h-full w-full">
                <Image src={"/images/employee.svg"} alt="image" fill className="object-cover xl:object-contain"/>
            </div>
        </div>
      </div>

      {/* You can be a Certified Career Planner, IF YOU ARE A */}
      <div>You can be a Certified Career Planner, IF YOU ARE A</div>
    </div>
  );
};
